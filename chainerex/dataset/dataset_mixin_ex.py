...
class DatasetMixinEX(object):
    ...
    def __getitem__(self, index):
        ...
        .. admonition:: Example
           ...
           >>> import numpy
           >>> from chainerex import dataset
           >>> class SimpleDataset(dataset.DatasetMixinEX):
    ...
    def features(self):
        if self._features_indexer is None:
            self._features_indexer = DatasetMixinEXFeatureIndexer(self)
...
class DatasetMixinEXFeatureIndexer(BaseFeatureIndexer):
    ...
    def __init__(self, dataset):
        ...
        Args:
            dataset (DatasetMixinEX): DatasetMixinEX instance
        """
        super(DatasetMixinEXFeatureIndexer, self).__init__(dataset)
